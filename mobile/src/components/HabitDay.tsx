...
import { genrateProgressPercentage } from "../utils/generate-progress-percentage";
...
export function HabitDay({amountOfHabits =0, amountCompleted = 0, date, ...rest}: Props){
    ...
    const amountAccomplishedPercentage = amountOfHabits > 0 ? genrateProgressPercentage(amountOfHabits, amountCompleted ) : 0;
    ...
    return(
        <TouchableOpacity
            className={clsx("rounded-lg border-2 m-1", {
             ...
             ["bg-violet-700 border-violet-500"] : amountAccomplishedPercentage > 20 && amountAccomplishedPercentage < 40,
