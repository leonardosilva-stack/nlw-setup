      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          className="border border-violet-500 font-semibold rounded-lg 
            px-6 py-4 flex gap-3 hover:border-violet-300 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background"
        >
